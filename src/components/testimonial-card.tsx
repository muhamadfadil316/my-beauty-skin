...
export function TestimonialCard({ name, role, message }: TestimonialCardProps) {
  return (
    <article className="group relative h-full overflow-hidden rounded-[28px] border border-[#e2ede7] bg-white p-6 shadow-[0_18px_40px_rgba(122,86,69,0.08)] transition-all duration-300 hover:-translate-y-1.5 hover:border-[#cde0d5] hover:shadow-[0_28px_64px_rgba(122,86,69,0.16)]">
      ...
      <div className="relative">
        ...
        <p className="text-sm leading-7 text-[#5a6e62]">“{message}”</p>
        <div className="mt-5 flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-[#4c6b5b]">{name}</p>
