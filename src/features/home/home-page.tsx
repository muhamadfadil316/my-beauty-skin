    ...
    <div className="space-y-16 px-4 py-6 sm:px-6 lg:px-8">
      <section className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
        <motion.div
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-[#dae8e0] bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-[#819c8d] shadow-sm backdrop-blur-sm">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#a2c9b6] opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-[#688d7b]" />
            </span>
          ...
          <div className="space-y-5">
            <h1 className="max-w-3xl font-display text-4xl leading-[1.08] sm:text-5xl lg:text-6xl">
              <span className="text-[#4c6b5b]">Temukan produk yang cocok untuk </span>
              <span className="text-gradient">kulit dan rambut</span>
              <span className="text-[#4c6b5b]"> Anda.</span>
            </h1>
            <p className="max-w-2xl text-sm leading-7 text-[#5a6e62] sm:text-base md:text-lg">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {heroStats.map((stat) => (
              <div key={stat.label} className="rounded-[26px] border border-[#e2ede7] bg-white/85 p-5 shadow-[0_14px_30px_rgba(122,86,69,0.08)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#cde0d5] hover:shadow-[0_22px_46px_rgba(122,86,69,0.16)]">
                <p className="font-display text-2xl text-gradient sm:text-3xl">{stat.value}</p>
                <p className="mt-1 text-sm text-[#5a6e62]">{stat.label}</p>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            {promises.map((promise) => (
              <span key={promise} className="inline-flex items-center gap-2 rounded-full border border-[#dae8e0] bg-white px-4 py-2 text-sm text-[#5a6e62] shadow-sm">
                <CheckCircle2 className="h-4 w-4 text-[#819c8d]" />
                {promise}
              </span>
            ))}
          </div>
        ...
        >
          ...
          <div className="beauty-grid relative overflow-hidden rounded-[40px] border border-white/70 bg-white/65 p-6 shadow-[0_28px_80px_rgba(122,86,69,0.14)] backdrop-blur-sm">
            <div className="relative overflow-hidden rounded-[34px] border border-[#e2ede7] bg-linear-to-br from-[#fcfdfc] via-[#f4f8f6] to-[#eaf2ed] p-8 shadow-[0_18px_40px_rgba(122,86,69,0.08)]">
              <div className="absolute -left-10 top-8 h-36 w-36 rounded-full bg-[#d4e8df]/45 blur-3xl" />
              <div className="absolute -bottom-14 right-2 h-44 w-44 rounded-full bg-[#c2dcd0]/45 blur-3xl" />

              <div className="relative max-w-sm space-y-4">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#b2d4c3]">Kebutuhan produk</p>
                <h2 className="font-display text-3xl leading-tight text-[#1a2b22] sm:text-4xl">Pilihan tepat, kulit nyaman.</h2>
              ...
              <div className="relative mt-10 flex items-end justify-center gap-4">
                ...
                <div className="animate-float h-40 w-28 rounded-[34px] border border-white/90 bg-white/92 shadow-[0_22px_46px_rgba(122,86,69,0.12)]">
                  <div className="mx-auto mt-3 h-6 w-16 rounded-full bg-linear-to-r from-[#688d7b] to-[#8fb8a2]" />
                  <div className="mx-auto mt-8 h-2 w-12 rounded-full bg-[#b8d6c6]" />
                  <div className="mx-auto mt-2 h-2 w-14 rounded-full bg-[#b8d6c6]" />
                  <div className="mx-auto mt-10 h-6 w-12 rounded-full bg-[#d4e8df]" />
                </div>
              ...
              <div className="relative mt-8 flex flex-wrap items-center gap-3 text-xs font-semibold uppercase tracking-[0.22em] text-[#60796b]">
      ...
      <section className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {mockFaqs.map((faq) => (
            <details key={faq.question} className="group rounded-[28px] border border-[#e2ede7] bg-white p-6 shadow-[0_18px_40px_rgba(122,86,69,0.08)] transition-all duration-300 hover:border-[#cde0d5] hover:shadow-[0_24px_54px_rgba(122,86,69,0.14)] open:bg-[#f8faf9]">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-semibold text-[#4c6b5b]">
                {faq.question}
                <Plus className="h-5 w-5 shrink-0 text-[#819c8d] transition-transform duration-300 group-open:rotate-45" />
              </summary>
              <p className="mt-4 text-sm leading-7 text-[#5a6e62]">{faq.answer}</p>
            </details>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[36px] border border-[#e2ede7] bg-linear-to-br from-[#688d7b] via-[#789e8a] to-[#88b09a] px-6 py-10 text-white shadow-[0_28px_70px_rgba(157,111,120,0.22)] sm:px-10">
          <div className="pointer-events-none absolute -right-16 -top-20 h-64 w-64 rounded-full bg-white/15 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-24 -left-10 h-64 w-64 rounded-full bg-[#c9e2d5]/25 blur-3xl" />
          <div className="beauty-grid pointer-events-none absolute inset-0 opacity-30" />
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="space-y-4">
              <p className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.3em] text-[#e5f2eb] backdrop-blur-sm">
            ...
            <div className="min-w-0 rounded-[28px] border border-white/15 bg-white/10 p-4 shadow-[0_18px_40px_rgba(80,50,52,0.2)] backdrop-blur-sm sm:min-w-105">
              <div className="grid gap-3 sm:grid-cols-[1fr_auto]">
                ...
                <Button type="button" className="bg-[#f0f6f3] text-[#4c6b5b] hover:bg-white">Gabung</Button>
              </div>
